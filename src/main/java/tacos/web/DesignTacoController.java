...
public class DesignTacoController {
	...
	public String showDesignForm(Model model) {
		log.info("go into \"showDesignForm()\" method");
	...
	/*
	 * @PostMapping public String processDesign(Taco design) {
	 * log.info("Processing design: " + design); return "redirect:/orders/current";
	 * }
	 */
